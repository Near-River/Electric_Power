 ...
 */
public class GenerateImportExcel {
    /**
     * 导入报表Excel数据，生成用户表的数据库导入语句
     *
     * @param formFile 导入的Excel文件
     * @return list ArrayList 返回从文件中读取的数据列表
     * @throws Exception
     */
    public static ArrayList<String[]> generateUserSql(File formFile) throws Exception {
        InputStream in = null;
