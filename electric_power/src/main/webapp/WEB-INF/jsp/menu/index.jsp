...
<body onload="ini()">
<form action="${pageContext.request.contextPath}/system/menuManage_home.action" method="post" target="_top">
                                ...
                                <tr>
                                    ...
                                    <td height="99" width="27%">
                                        <table border="0" width="70%" id="table4">
                                            <tr>
                                                <td colspan="2">
                                                    <span style="color:red;">${fieldErrors.loginFailure[0]}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="100">
                                                ...
                                                <td>
                                                    <input type="text" name="loginName" cssStyle="width: 125px"
                                                           size="20" maxlength="25" value="${requestScope.loginName}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="100">
                                                    <img border="0"
                                                         ...
                                                         width="75" height="20"></td>
                                                <td>
                                                    <input type="password" name="password" cssStyle="width: 125px"
                                                           size="20" maxlength="25" value="${requestScope.password}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="100">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img src="${pageContext.request.contextPath}/image.jsp"
                                                                     name="imageNumber" id="imageNumber"
                                                                     style="cursor:pointer" title="点击可更换图片" height="20"
                                            ...
                                            <tr>
                                                <td width="100">
                                                    <img border="0"
                                                         ...
                                                         width="75" height="20"></td>
                                                <td>
                                                    <input type="checkbox" name="rememberMe" id="rememberMe" value="yes" ${requestScope.rememberMe} />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="100"></td>
                                                <td width="100">
                                                    <input type="button" class=btn_mouseout
                                                           ...
                                                           name="huifubtn" onclick="check()"></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
