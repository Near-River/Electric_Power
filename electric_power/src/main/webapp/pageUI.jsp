                ...
                <tr>
                    ...
                    <s:else>
                        <td width="8%" align="center"><u>
                            <a href="#"
                               onClick="gotopage('${pageContext.request.contextPath }/system/userManage_index.action','start')">首页&nbsp;&nbsp;|</a></u>
                        </td>
                        <td width="10%" align="center"><u>
                            <a href="#"
                               onClick="gotopage('${pageContext.request.contextPath }/system/userManage_index.action','prev')">上一页&nbsp;&nbsp;&nbsp;|</a></u>
                        </td>
                    </s:else>
                    ...
                    <s:else>
                        <td width="10%" align="center"><u>
                            <a href="#"
                               onClick="gotopage('${pageContext.request.contextPath }/system/userManage_index.action','next')">下一页&nbsp;&nbsp;&nbsp;|</a></u>
                        </td>
                        <td width="8%" align="center"><u>
                            <a href="#"
                               onClick="gotopage('${pageContext.request.contextPath }/system/userManage_index.action','end')">末页</a></u>
                        </td>
                    </s:else>
                    ...
                    <td width="21%" align="right">至第<input size="1" type="text" name="goPage">页
                        ...
                        <span style="text-decoration: underline;">
                            <a href="#"
                               onClick="gotopage('${pageContext.request.contextPath }/system/userManage_index.action','go')">确定</a></span>
                    </td>
